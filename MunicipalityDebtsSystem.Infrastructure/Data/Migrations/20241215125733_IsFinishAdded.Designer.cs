...
namespace MunicipalityDebtsSystem.Data.Migrations
{
    ...
    [Migration("20241215125733_IsFinishAdded")]
    partial class IsFinishAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 3,
                            ConcurrencyStamp = "0c229126-1a28-494d-bf87-f1a90df84c1c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKNHycbKilwKkHBaKKQY34E2c4Lq3eEYa4AhpB+sKzg8hanbuKApUpdqpBoYq1Xbzg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "69c38437-27cf-4225-b784-b16ebedebeb1",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 3,
                            ConcurrencyStamp = "840ddc00-ffd3-4338-b1bb-6d44f8adb7d9",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBD6GdPNRDt5Po9M3K1I8uujBLfzWQyvITRrHoKRoIelje1CdU2Lgf/tpfVxOMg2pg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cba33c5f-aa3a-4e0c-83a1-1a26eeb6f78d",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 3,
                            ConcurrencyStamp = "f8f527e8-7303-41bd-9052-8738bf75c690",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOIbhN6G+CSFH5rYYOpmQqUlh6tqxIGM+f2snnwZeIRD52CVHnlpmf/g86b8RIvHBw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5ed1f3e9-9442-4eaa-b2c5-05b4cdc73910",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.Cover", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasComment("Date creation of the cover");

                    b.Property<DateTime?>("DateDeleted")
                        .HasColumnType("datetime2")
                        .HasComment("Date of deletion of the cover");
                    ...
                    b.Property<string>("UserCreated")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
                        .HasComment("User created the cover");

                    b.Property<string>("UserDeleted")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
                        .HasComment("User marked the cover as deleted");
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.CurrencyRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Identifier ot the rate");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int>("CurrencyId")
                        .HasColumnType("int")
                        .HasComment("Identifier of the currency");

                    b.Property<decimal>("RateFromBGN")
                        .HasColumnType("decimal(18,4)")
                        .HasComment("Rate from local - BGN to foreign currency");
                    ...
                    b.ToTable("CurrenciesRates", "mundebt", t =>
                        {
                            t.HasComment("Table for currency rates");
                        });
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.Debt", b =>
                {
                    ...
                    b.Property<bool>("IsFinished")
                        .HasColumnType("bit")
                        .HasComment("Shows if the debt is finished");
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.PeriodList", b =>
                {
                    ...
                    b.Property<bool>("IsUnlock")
                        .HasColumnType("bit")
                        .HasComment("Shows whether the period is unlocked");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.Debt", b =>
                {
                    ...
                    b.HasOne("MunicipalityDebtsSystem.Infrastructure.Data.Models.Entities.Debt", "ParentDebt")
                        .WithMany("ChildDebts")
                        .HasForeignKey("DebtParentId")
